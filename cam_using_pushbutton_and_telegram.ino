...
const char* ssid = "Divyesh's Redmi Note 10T 5G";  //WiFi Name
const char* password = "divyesh2505";              //WiFi Password

// Use @myidbot to find out the chat ID of an individual or a group
// You need to click "start" on a bot before it can message you 
// Initialize Telegram BOT
String chatId = "1715160096";
String BOTtoken = "5831948850:AAEdMpJvW7jeRhM7UX4IuhbHyWB1fCZa-q4";
